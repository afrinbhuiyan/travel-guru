        ...
        <div className="flex-1 items-center justify-center px-4 lg:px-40">
          <div className="w-full h-full flex flex-row text-white items-center justify-between">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <IoBriefcaseOutline className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-600" />
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <MdCalendarToday className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 pointer-events-none" />
                  </div>
                </div>
              ...
              <div className="pt-2">
                <Link to={user ? `/accommodations/${destination.id}` : "/login"}>
                  <button
                    type="submit"
